...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[360px] max-w-[calc(100vw-48px)] bg-background border border-foreground/10 shadow-2xl flex flex-col" style={{ height: "500px", maxHeight: "calc(100vh - 140px)" }}>
          {/* Header */}
